...
public class OrderMapper {
    ...
    public OrderDto toDto(Order entity) {
        ...
        return OrderDto.builder()
                ...
                .customerAddress(entity.getCustomer() != null ? entity.getCustomer().getAddress() : null)
                ...
                .deliveryPersonName(entity.getDeliveryPerson() != null
                        ? entity.getDeliveryPerson().getFirstname() + " " + entity.getDeliveryPerson().getLastname()
                        : null)
