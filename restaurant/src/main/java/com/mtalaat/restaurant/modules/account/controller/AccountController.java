...
public class AccountController {
    ...
    public ResponseEntity<ApiResponse> transactionTypes() {
        HttpStatus status = HttpStatus.OK;
        return ResponseEntity.status(status).body(ApiResponse.success("msg_accounts_fetched", FinancialTransactionType.values()  , status.value()));
    }
