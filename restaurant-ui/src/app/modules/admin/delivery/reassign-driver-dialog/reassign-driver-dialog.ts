...
@Component({
  ...
  templateUrl: './reassign-driver-dialog.html',
  providers: [MessageService],
})
export class ReassignDriverDialogComponent implements OnChanges {
  @Input() visible = false;
  @Input() deliveryId = 0;
  ...
  form = this.fb.group({
    newDriverId: [null as number | null, Validators.required],
  ...
  submit() {
    ...
    this.deliveryService.reassignDriver(
      this.deliveryId,
      { newDriverId: val.newDriverId!, reason: val.reason! },
      () => {
